...
async function dbConnect() {
    ...
    if (!cached.promise) {
        cached.promise = new Promise((resolve, reject)=>{
            __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].connect(mongoUri, {}).then((mongooseInstance)=>resolve(mongooseInstance)).catch((err)=>reject(err));
        });
    }
    try {
...
"[project]/src/app/modals/questions.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/api/submit/[id]/unlock/route.tsx [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/app/lib/mongodb.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$modals$2f$questions$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/app/modals/questions.ts [app-route] (ecmascript)");
...
async function POST(req) {
    ...
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
        ...
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$modals$2f$questions$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOneAndUpdate({
            "questions.id": questionId
        }, {
            $set: {
                "questions.$[elem].status": "Unlocked"
            }
        }, {
            arrayFilters: [
                {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__b30287._.js.map