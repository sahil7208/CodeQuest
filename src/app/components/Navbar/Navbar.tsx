  ...
  return (
    <header className="w-screen bg-[#0c0c29] text-white shadow-lg fixed z-10">
      <div className="container mx-auto flex flex-wrap p-4 md:px-10 flex-col md:flex-row items-center">
        ...
        <nav className="hidden sm:flex lg:w-2/5 flex-wrap items-center justify-start text-base space-x-8 md:ml-auto">
          <a
        ...
        <div className="lg:w-2/5 hidden  sm:inline-flex lg:justify-end ml-5 lg:ml-0">
